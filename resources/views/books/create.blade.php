                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-4 gap-6">
                            ...
                            <div class="col-span-6 sm:row-start-2 sm:col-span-2">
                                ...
                                <input placeholder="$" type="text" name="first_name" id="first_name" autocomplete="given-name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            </div>
                            ...
                            <div class="col-span-6 sm:row-start-3 sm:col-span-3">
                                <label for="country" class="block text-sm font-medium text-gray-700">Author</label>
